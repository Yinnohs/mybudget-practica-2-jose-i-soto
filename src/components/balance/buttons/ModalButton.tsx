...
export const ModalButton:React.FC<ModalButtonPropsType> = ({marginTop, color = "#000", action}:ModalButtonPropsType)=>{
    return(
        <>
            <Pressable onPress={()=> alert("hola como estas?")} style={{...styles.container,marginTop:marginTop}}>
